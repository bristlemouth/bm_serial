...
typedef struct {
  ...
  // Function called when a rtc get request is received
  bool (*rtc_get_request_fn)(void);

  // Function called when a rtc get reply is received
  bool (*rtc_get_reply_fn)(uint64_t utc_s);
